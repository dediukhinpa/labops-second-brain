...
# Замер 2026-09-02 на живом вайте: при K=60 вклад первого места (1/61) и
# восемнадцатого (1/78) различаются на 22%, тогда как temporal_decay и
# SOURCE_WEIGHTS дают разброс 67% и 100%. Смысл запроса не мог перевесить
# возраст заметки ни при каких условиях: запрос дословно по заголовку выдавал
# нужную заметку пятой, а первыми шли свежие, но нерелевантные. K=10 поднимает
# разброс релевантности до 36%; вместе со сжатым затуханием этого хватает.
_RRF_K = 10
